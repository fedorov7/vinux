...
call te#feat#feat_enable('g:feat_enable_complete', 1)
call te#feat#feat_enable('g:feat_enable_jump', 1)
call te#feat#feat_enable('g:feat_enable_tmux', 0)
call te#feat#feat_enable('g:feat_enable_git', 1)
call te#feat#feat_enable('g:feat_enable_c', 1)
call te#feat#feat_enable('g:feat_enable_markdown', 1)
call te#feat#feat_enable('g:feat_enable_vim', 0)
call te#feat#feat_enable('g:feat_enable_gui', 1)
call te#feat#feat_enable('g:feat_enable_tools', 1)
call te#feat#feat_enable('g:feat_enable_edit', 1)
...
call te#feat#feat_enable('g:feat_enable_writing', 1)
call te#feat#feat_enable('g:feat_enable_zsh', 0)
call te#feat#feat_enable('g:feat_enable_fun', 0)
call te#feat#feat_enable('g:feat_enable_custom', 1)
